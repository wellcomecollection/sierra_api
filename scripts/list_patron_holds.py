#!/usr/bin/env python3
"""
Look up the API response for a patron's holds using the patron number, e.g.
...
from api_client import identity_client, HOLD_FIELDS
...
if __name__ == "__main__":
    ...
    resp = sierra.client.get(
        f"/patrons/{patron_number}/holds",
        params={"fields": ",".join(HOLD_FIELDS)},
    )
